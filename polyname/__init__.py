...
from .check_database import remove_duplicate_names_smiles
...
from .combine_files import remove_duplicate_file
from .callCDEsh import command_line_cde
from .callCDEsh import extract_names
from .callCDEsh import remove_duplicates_list
